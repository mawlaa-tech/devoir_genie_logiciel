...
try {
	...
	private String sql_2() {
		...
		if (day.getSelectedIndex() == 0 && month.getSelectedIndex() == 0 && year.getSelectedIndex() == 0) {
			...
			sql = "select NAME,TYPE,DATE,TIME from login where NAME='" + username.getSelectedItem() + "' and DATE='"
...
try {
	...
	private String sql() {
		...
		if (month.getSelectedIndex() != 0 && year.getSelectedIndex() != 0 && username.getSelectedIndex() == 0) {
			sql = "select NAME,TYPE,DATE,TIME from login where DATE='" + day.getSelectedItem() + "-"
