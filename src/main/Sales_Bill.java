...
get_Total();
	...
	private boolean check_1() throws HeadlessException {
	...
	private boolean check(boolean check) throws HeadlessException {
		int c = JOptionPane.showConfirmDialog(null,
				"The Same Bill is Exist Before\n\nAre you want to Continue and Repeat it", "Warning", 2);
		if (c == 0) {
			check = false;
		}
		return check;
