...
double amount = 0; 
	...
	private String sql() {
		String sql;
		if (day.getSelectedIndex() == 0 && month.getSelectedIndex() == 0 && year.getSelectedIndex() == 0) {
			sql = "select USER_NAME,BARCODE,NAME,QUANTITY,PRICE,AMOUNT,DATE from history_sales where USER_NAME='"
					+ username.getSelectedItem() + "' ";
		} else {
			sql = "select USER_NAME,BARCODE,NAME,QUANTITY,PRICE,AMOUNT,DATE from history_sales where USER_NAME='"
					+ username.getSelectedItem() + "' and DATE='" + day.getSelectedItem() + "-"
...
private String sql_5() {
	String sql;
	if (username.getSelectedIndex() == 0) {
		sql = "select USER_NAME,BARCODE,NAME,QUANTITY,PRICE,AMOUNT,DATE from history_sales where DATE='"
